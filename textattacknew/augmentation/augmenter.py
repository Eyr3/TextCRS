...
from textattacknew.constraints import PreTransformationConstraint
from textattacknew.metrics.quality_metrics import Perplexity, USEMetric
...
class Augmenter:
    ...
    Example::
        >>> from textattacknew.transformations import WordSwapRandomCharacterDeletion, WordSwapQWERTY, CompositeTransformation
