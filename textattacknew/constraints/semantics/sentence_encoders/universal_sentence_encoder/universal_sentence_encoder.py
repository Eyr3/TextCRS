...
from textattacknew.constraints.semantics.sentence_encoders import SentenceEncoder
from textattacknew.shared.utils import LazyLoader
...
class UniversalSentenceEncoder(SentenceEncoder):
    ...
    def encode(self, sentences):
        if not self.model:
            ...
            self.model = hub.load("/data/xinyu/data/nlp/universal-sentence-encoder_4/")
