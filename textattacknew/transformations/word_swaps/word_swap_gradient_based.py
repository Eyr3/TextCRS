...
from textattacknew.shared.validators import validate_model_gradient_word_swap_compatibility
...
class WordSwapGradientBased(WordSwap):
    ...
    def __init__(self, model_wrapper, top_n=1):
        ...
        if not isinstance(model_wrapper, textattacknew.models.wrappers.ModelWrapper):
