...
class AttackedText:
    ...
    def pos_of_word_index(self, desired_word_idx):
        ...
        if not self._pos_tags:
            ...
            textattacknew.shared.utils.flair_tag(sentence)
            self._pos_tags = sentence
        flair_word_list, flair_pos_list = textattacknew.shared.utils.zip_flair_result(
            self._pos_tags
        )
    ...
    def ner_of_word_index(self, desired_word_idx, model_name="ner"):
        ...
        if not self._ner_tags:
            ...
            textattacknew.shared.utils.flair_tag(sentence, model_name)
            self._ner_tags = sentence
        flair_word_list, flair_ner_list = textattacknew.shared.utils.zip_flair_result(
            self._ner_tags, "ner"
        )
    ...
    def printable_text(self, key_color="bold", key_color_method=None):
        ...
        # color the key.
            ...
            if key_color_method:
                ...
                def ck(k):
                    return textattacknew.shared.utils.color_text(
