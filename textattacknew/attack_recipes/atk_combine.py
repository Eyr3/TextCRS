...
from textattacknew.constraints.grammaticality import PartOfSpeech
...
from textattacknew.transformations import WordSwapEmbedding, WordInnerSwapRandom, WordInsertionRandomSynonym, \
    WordDeletion, CompositeTransformation

from .attack_recipe import AttackRecipe


class AttacksCombination(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        #
        transformation = CompositeTransformation((WordSwapEmbedding(max_candidates=250), WordInnerSwapRandom(),
                                                  WordInsertionRandomSynonym(), WordDeletion()))
        #
        ...
        constraints.append(MaxModificationRate(max_rate=0.1, min_threshold=8))
