...
class BAEGargInsert2019(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        shared_masked_lm = AutoModelForCausalLM.from_pretrained(
            "bert-base-uncased"
        )
        ...
        #
        search_method = GreedySearch()  # GreedyWordSwapWIR(wir_method="delete")

        return BAEGargInsert2019(goal_function, constraints, transformation, search_method)
