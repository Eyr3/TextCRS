...
We provide a number of pre-built attack recipes, which correspond to attacks from the literature. To run an attack recipe from the command line, run::
    ...
    textattacknew attack --recipe [recipe_name]
...
from .bae_garg_insert_2019 import BAEGargInsert2019
...
from .insert_word_synonym import InsertWordSyn
from .word_order_swap import WordOrderSwap
from .delete_word import DeleteWord
from .atk_combine import AttacksCombination
