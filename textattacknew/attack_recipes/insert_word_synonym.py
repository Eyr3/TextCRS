...
from textattacknew.transformations import WordInsertionRandomSynonym
...
class InsertWordSyn(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        constraints.append(MaxModificationRate(max_rate=0.1, min_threshold=8))  # max_rate=0.05, min_threshold=2

        use_constraint = UniversalSentenceEncoder(
            threshold=0.7,  # 0.936338023,
            metric="cosine",
