...
from textattacknew.constraints.grammaticality.language_models import GPT2
...
from textattacknew.constraints.semantics.sentence_encoders import ThoughtVector
