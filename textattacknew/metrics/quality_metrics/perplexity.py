...
from textattacknew.attack_results import FailedAttackResult, SkippedAttackResult
from textattacknew.metrics import Metric
import textattacknew.shared.utils
...
class Perplexity(Metric):
    def __init__(self, model_name="gpt2"):
        ...
        if model_name == "gpt2":
            ...
            self.ppl_model.to(textattacknew.shared.utils.device)
