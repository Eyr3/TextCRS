...
import torch
import transformers
from .. import transformers1

import textattacknew
from textattacknew.models.helpers import T5ForTextToText
from textattacknew.models.tokenizers import T5Tokenizer
...
class HuggingFaceModelWrapper(PyTorchModelWrapper):
    ...
    def __init__(self, model, tokenizer):
        assert isinstance(
            model, (transformers.PreTrainedModel, T5ForTextToText, transformers1.PreTrainedModel)
        ...
        assert isinstance(
            ...
            (
                ...
                T5Tokenizer,
                transformers1.PreTrainedTokenizer
            ),
    ...
    def get_grad(self, text_input):
        ...
        """
        if isinstance(self.model, textattacknew.models.helpers.T5ForTextToText):
