...
ATTACK_RECIPE_NAMES = {
    "alzantot": "textattacknew.attack_recipes.GeneticAlgorithmAlzantot2018",
    "bae": "textattacknew.attack_recipes.BAEGarg2019",
    "bert-attack": "textattacknew.attack_recipes.BERTAttackLi2020",
    "faster-alzantot": "textattacknew.attack_recipes.FasterGeneticAlgorithmJia2019",
    "deepwordbug": "textattacknew.attack_recipes.DeepWordBugGao2018",
    "hotflip": "textattacknew.attack_recipes.HotFlipEbrahimi2017",
    "input-reduction": "textattacknew.attack_recipes.InputReductionFeng2018",
    "kuleshov": "textattacknew.attack_recipes.Kuleshov2017",
    "morpheus": "textattacknew.attack_recipes.MorpheusTan2020",
    "seq2sick": "textattacknew.attack_recipes.Seq2SickCheng2018BlackBox",
    "textbugger": "textattacknew.attack_recipes.TextBuggerLi2018",
    "textfooler": "textattacknew.attack_recipes.TextFoolerJin2019",
    "pwws": "textattacknew.attack_recipes.PWWSRen2019",
    "iga": "textattacknew.attack_recipes.IGAWang2019",
    "pruthi": "textattacknew.attack_recipes.Pruthi2019",
    "pso": "textattacknew.attack_recipes.PSOZang2020",
    "checklist": "textattacknew.attack_recipes.CheckList2020",
    "clare": "textattacknew.attack_recipes.CLARE2020",
    "a2t": "textattacknew.attack_recipes.A2TYoo2021",
}


BLACK_BOX_TRANSFORMATION_CLASS_NAMES = {
    "random-synonym-insertion": "textattacknew.transformations.RandomSynonymInsertion",
    "word-deletion": "textattacknew.transformations.WordDeletion",
    "word-swap-embedding": "textattacknew.transformations.WordSwapEmbedding",
    "word-swap-homoglyph": "textattacknew.transformations.WordSwapHomoglyphSwap",
    "word-swap-inflections": "textattacknew.transformations.WordSwapInflections",
    "word-swap-neighboring-char-swap": "textattacknew.transformations.WordSwapNeighboringCharacterSwap",
    "word-swap-random-char-deletion": "textattacknew.transformations.WordSwapRandomCharacterDeletion",
    "word-swap-random-char-insertion": "textattacknew.transformations.WordSwapRandomCharacterInsertion",
    "word-swap-random-char-substitution": "textattacknew.transformations.WordSwapRandomCharacterSubstitution",
    "word-swap-wordnet": "textattacknew.transformations.WordSwapWordNet",
    "word-swap-masked-lm": "textattacknew.transformations.WordSwapMaskedLM",
    "word-swap-hownet": "textattacknew.transformations.WordSwapHowNet",
    "word-swap-qwerty": "textattacknew.transformations.WordSwapQWERTY",
}


WHITE_BOX_TRANSFORMATION_CLASS_NAMES = {
    "word-swap-gradient": "textattacknew.transformations.WordSwapGradientBased"
}
...
CONSTRAINT_CLASS_NAMES = {
    ...
    #
    "embedding": "textattacknew.constraints.semantics.WordEmbeddingDistance",
    "bert": "textattacknew.constraints.semantics.sentence_encoders.BERT",
    "infer-sent": "textattacknew.constraints.semantics.sentence_encoders.InferSent",
    "thought-vector": "textattacknew.constraints.semantics.sentence_encoders.ThoughtVector",
    "use": "textattacknew.constraints.semantics.sentence_encoders.UniversalSentenceEncoder",
    "muse": "textattacknew.constraints.semantics.sentence_encoders.MultilingualUniversalSentenceEncoder",
    "bert-score": "textattacknew.constraints.semantics.BERTScore",
    #
    # Grammaticality constraints
    #
    "lang-tool": "textattacknew.constraints.grammaticality.LanguageTool",
    "part-of-speech": "textattacknew.constraints.grammaticality.PartOfSpeech",
    "goog-lm": "textattacknew.constraints.grammaticality.language_models.GoogleLanguageModel",
    "gpt2": "textattacknew.constraints.grammaticality.language_models.GPT2",
    "learning-to-write": "textattacknew.constraints.grammaticality.language_models.LearningToWriteLanguageModel",
    "cola": "textattacknew.constraints.grammaticality.COLA",
    #
    # Overlap constraints
    #
    "bleu": "textattacknew.constraints.overlap.BLEU",
    "chrf": "textattacknew.constraints.overlap.chrF",
    "edit-distance": "textattacknew.constraints.overlap.LevenshteinEditDistance",
    "meteor": "textattacknew.constraints.overlap.METEOR",
    "max-words-perturbed": "textattacknew.constraints.overlap.MaxWordsPerturbed",
    #
    # Pre-transformation constraints
    #
    "repeat": "textattacknew.constraints.pre_transformation.RepeatModification",
    "stopword": "textattacknew.constraints.pre_transformation.StopwordModification",
    "max-word-index": "textattacknew.constraints.pre_transformation.MaxWordIndexModification",
}


SEARCH_METHOD_CLASS_NAMES = {
    "beam-search": "textattacknew.search_methods.BeamSearch",
    "greedy": "textattacknew.search_methods.GreedySearch",
    "ga-word": "textattacknew.search_methods.GeneticAlgorithm",
    "greedy-word-wir": "textattacknew.search_methods.GreedyWordSwapWIR",
    "pso": "textattacknew.search_methods.ParticleSwarmOptimization",
}
...
GOAL_FUNCTION_CLASS_NAMES = {
    ...
    #
    "targeted-classification": "textattacknew.goal_functions.classification.TargetedClassification",
    "untargeted-classification": "textattacknew.goal_functions.classification.UntargetedClassification",
    "input-reduction": "textattacknew.goal_functions.classification.InputReduction",
    #
    # Text goal functions
    #
    "minimize-bleu": "textattacknew.goal_functions.text.MinimizeBleu",
    "non-overlapping-output": "textattacknew.goal_functions.text.NonOverlappingOutput",
    "text-to-text": "textattacknew.goal_functions.text.TextToTextGoalFunction",
}


@dataclass
class AttackArgs:
    """Attack arguments to be passed to :class:`~textattacknew.Attacker`.
    ...
    def _add_parser_args(cls, parser):
        ...
        parser.add_argument(
            ...
            'Example for command line use: `--log-to-wandb {"project": "textattacknew"}`.',
        )
        parser.add_argument(
            "--disable-stdout",
            action="store_true",
    ...
    def create_loggers_from_args(cls, args):
        ...
        # Create logger
        attack_log_manager = textattacknew.loggers.AttackLogManager()
