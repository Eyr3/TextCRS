...
Accs = \
{'lstm': \
[79.8, 80.4, 80.8, 81,  # AG
60.8, 62.4, 63, 63.2,  #AMAZON
60.4, 61.6, 62.8, 63  #IMDB
],
'bert': \
[80.2, 80.6, 80.6, 80.6,
72.2, 72.8, 73, 73,
...
data = np.array(Accs['lstm']).reshape((3,4))/100
...
ax1.set_xticks(np.arange(len(X)), X)
# ax1.set_xlabel("Dataset")
ax1.set_ylim(0.5, 0.9)
ax1.set_ylabel('Certified accuracy')


ax2 = plt.subplot(1, 2, 2)
data = np.array(Accs['bert']).reshape((3,4))/100
...
plt.tight_layout()
plt.savefig(f'/home/zhangxinyu/code/fgws-main/draw/compare_N/compare_data_model.png', bbox_inches="tight") #
